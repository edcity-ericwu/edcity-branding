...
- **Expansive Intelligence:** dichroic glass casting refractions, a fluted translucent partition with light passing through, a modernist pavilion of large openings, marbled-ink illustration.
...
- **C · Expansive Intelligence:** invisible 12-column grid; opening resolves into the hero on one grid module; refraction planes, perspective demo, comparison toggle; peach reserved for family/home moments; figures numbered [圖 01]–[圖 05].
