...
- **B · Connected Path** — guidance and connection (visible paths, nodes, next steps).
...
| B | Connected Path | `palette_optionB.html` | `layout_optionB.html` | quarterre.com, pellmell.fr |
